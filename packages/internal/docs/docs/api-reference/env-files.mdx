...
| `MF_HOSTED_ZONE_ID`      | Id of a AWS Route53 hosted zone of a domain used to host services of this environment                                                  | ``                                            |
| `MF_HOSTED_ZONE_NAME`    | Name of a AWS Route53 hosted zone of a domain used to host services of this environment                                                | `example.com`                                 |
| `MF_DOMAIN_ADMIN_PANEL`  | A domain used to host an admin panel service                                                                                           | `admin.example.com`                           |
| `MF_DOMAIN_FLOWER`       | A domain used to host the Flower panel                                                                                                 | `flower.example.com`                          |
| `MF_DOMAIN_API`          | A domain used to host an API backend service                                                                                           | `api.example.com`                             |
| `MF_DOMAIN_WEB_APP`      | A domain used to host the web application                                                                                              | `app.example.com`                             |
| `MF_DOMAIN_DOCS`         | A domain used to host the documentation                                                                                                | `docs.example.com`                            |
| `MF_DOMAIN_CDN`          | A domain used to static assets delivery                                                                                                | `cdn.example.com`                             |
