...
Market Frontier offers a powerful CMS functionality out of the box that is integrated with Contentful.

Using the CMS functionality in Market Frontier allows developers and administrators to easily manage content in the
...
### CMS Functionality in Market Frontier

Market Frontier offers two parts of the application that use content from the CMS.
...
The two implementations of the CMS functionality in Market Frontier are just examples of how to use the integration
