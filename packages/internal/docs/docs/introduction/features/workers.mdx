...
### Async Workers in the Market Frontier

The Market Frontier includes two types of “async workers” to manage asynchronous jobs:
...
:::info
If you would like to learn more about the technical aspects of the async workers in Market Frontier, please refer to:
