...
| `VITE_WEB_APP_URL`                   | Absolute URL to web application. By default it's the value kept in global environment setting `MF_DOMAIN_WEB_APP`                                                                                                        | `https://app.demo.saas.apptoku.com`          |
