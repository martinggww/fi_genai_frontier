...
```
Create a new IAM policy `market_frontier_admin_assume_policy`
    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:iam::796973511751:role/PawsyAdminRole"
        }
    ]
}
```
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::796973511751:user/market_frontier_admin"
            },
            "Action": "sts:AssumeRole"
        }
    ]
